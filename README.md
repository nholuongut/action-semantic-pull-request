...
This is a GitHub Action that ensures that your pull request titles match the [Conventional Commits spec](https://www.conventionalcommits.org/). Typically, this is used in combination with a tool like [semantic-release](https://github.com/nholuongut/semantic-release) to automate releases.
...
jobs:
  main:
    ...
    steps:
      - uses: nholuongut/action-semantic-pull-request@v5
        env:
...
```yml
        with:
          ...
          # Default: https://github.com/nholuongut/conventional-commit-types
          types: |
            fix
            feat
          ...
          # See: https://github.com/cnholuongut/conventional-changelog/tree/main/packages/conventional-commits-parser#headerpattern
          headerPattern: '^(\w*)(?:\(([\w$.\-*/ ]*)\))?: (.*)$'
